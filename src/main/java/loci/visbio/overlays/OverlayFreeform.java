...
public class OverlayFreeform extends OverlayNodedObject {
	...
	public OverlayFreeform(final OverlayTransform overlay) {
		super(overlay);
	}

	/** Constructs a freeform. */
	public OverlayFreeform(final OverlayTransform overlay, final float x1,
	...
	public OverlayFreeform(final OverlayTransform overlay, final float[][] nodes)
	{
		super(overlay, nodes);
	}
